...
wss.on('connection', (ws, req) => {
    ...
    ws.on('message', async (messageStr) => {
        try {
            ...
            // Sanitize input (matching Python backend logic)
            ...
            // 3. Store in Database and Fetch Profile Info
            ...
            const insertQuery = `
                ...
                SELECT 
                    ...
                    p.avatar_url
                FROM inserted i
                LEFT JOIN public.profiles p ON i.sender_id = p.id;
            `;
            ...
            // Construct message object matching Supabase shape for frontend
            const savedMessage = {
                id: row.id,
