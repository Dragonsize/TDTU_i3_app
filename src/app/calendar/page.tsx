      ...
      <main className="px-4 lg:px-40 py-12 relative">
        <div className="mb-12">
          <h1 className="text-4xl lg:text-6xl font-black mb-4 tracking-tight text-slate-900 dark:text-white">
            Smart <span className="text-gradient">Calendar</span>
          </h1>
          <p className="text-slate-600 dark:text-white/60 text-lg">
            Manage your schedule, events, and deadlines all in one place.
          </p>
        </div>
        ...
        <div className="bg-white/50 dark:bg-transparent dark:glass-effect border border-slate-200 dark:border-white/10 shadow-xl dark:shadow-none rounded-2xl p-12">
          <div className="text-center space-y-6">
            <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-secondary/20 text-secondary">
            ...
            <p className="text-slate-600 dark:text-slate-400 max-w-lg mx-auto">
              We're developing a smart calendar system to help you organize your classes, assignments, and personal events with intelligent reminders.
            </p>
          </div>
        </div>
      </main>
